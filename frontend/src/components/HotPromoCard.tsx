...
// ===== STRICT GEOMETRY + CALM COLORED STYLES (идентично PromoCard) =====
...
// Основные кнопки по типам офферов - glassmorphism эффект
...
const BUTTON_LOADING = "flex items-center justify-center gap-2.5 px-5 rounded-lg border border-emerald-500/30 bg-emerald-500/15 backdrop-blur-sm text-emerald-100 font-semibold text-sm transition-all duration-300 ease-out w-full h-11"
      ...
      <div className={cardClasses} tabIndex={0} data-testid="hot-promo-card">
        ...
        {(cardModel.isRecommended || cardModel.isHot) && (
          <div className="flex flex-wrap items-center gap-2 mb-4">
            ...
            {/* ТАЙМЕР - ТОЛЬКО ДЛЯ "ГОРЯЧИХ" С ДАТОЙ ИСТЕЧЕНИЯ */}
